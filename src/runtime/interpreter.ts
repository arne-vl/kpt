...
export function evaluate(astNode: Statement, environment: Environment): RuntimeValue {
    switch (astNode.kind) {
        ...
        case "ArrayOperationExpression":
            return evaluate_array_add_expression(astNode as ArrayOperationExpression, environment)
